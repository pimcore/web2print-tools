...
class Outputchanneltable extends Document\Tag implements \Iterator {
        ...
        if(empty($this->elements)) {
            ...
            foreach ($this->elementIds as $elementId) {
                if($elementId["type"] == "meta") {
                    ...
                    $classname = "\\Pimcore\\Model\\Document\\Tag\\Outputchanneltable\\MetaEntry\\" . ucfirst($subType);
    ...
    public function getDataEditmode() {
        ...
        if (is_array($this->elements) && count($this->elements) > 0) {
            foreach ($this->elements as $element) {
                ...
                else if($element instanceof Document\Tag\Outputchanneltable\MetaEntry) {
    ...
    public function frontend() {
        ...
        if (is_array($this->elements) && count($this->elements) > 0) {
            foreach ($this->elements as $element) {
                if($element instanceof Document\Tag\Outputchanneltable\MetaEntry) {
