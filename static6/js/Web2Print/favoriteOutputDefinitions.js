...
pimcore.registerNS("pimcore.plugin.web2print.favoriteOutputDefinitionsTable");
pimcore.plugin.web2print.favoriteOutputDefinitionsTable = Class.create({

    dataUrl: '/plugin/Web2Print/admin/favorite-output-definitions-table-proxy',
