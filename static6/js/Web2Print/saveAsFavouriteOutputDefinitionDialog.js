...
pimcore.registerNS("pimcore.plugin.web2print.SaveAsFavouriteOutputDefinitionDialog");
pimcore.plugin.web2print.SaveAsFavouriteOutputDefinitionDialog = Class.create({
